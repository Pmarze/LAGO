...
void fun_println(char arr[]){
	...
	for(i=0 ; i<strlen(arr); i++){
		...
		if(arr[i]==abecedary_upper[16]){
			Q_M(fd);
		}
		if(arr[i]==abecedary_upper[17]){
			R_M(fd);
		}
		if(arr[i]==abecedary_upper[18]){
			S_M(fd);
		}
		if(arr[i]==abecedary_upper[19]){
			T_M(fd);
		}
		if(arr[i]==abecedary_upper[20]){
			U_M(fd);
		}
		if(arr[i]==abecedary_upper[21]){
			V_M(fd);
		}
		if(arr[i]==abecedary_upper[22]){
			W_M(fd);
		}
		if(arr[i]==abecedary_upper[23]){
			X_M(fd);
		}
		if(arr[i]==abecedary_upper[24]){
			Y_M(fd);
		}
		if(arr[i]==abecedary_upper[25]){
			Z_M(fd);
		}
		if(arr[i]==abecedary_lower[0]){
			a_MI(fd);
		}
		if(arr[i]==abecedary_lower[1]){
			b_MI(fd);
		}
		if(arr[i]==abecedary_lower[2]){
			c_MI(fd);
		}
		if(arr[i]==abecedary_lower[3]){
			d_MI(fd);
		}
		if(arr[i]==abecedary_lower[4]){
			e_MI(fd);
		}
		if(arr[i]==abecedary_lower[5]){
			f_MI(fd);
		}
		if(arr[i]==abecedary_lower[6]){
			g_MI(fd);
		}
		if(arr[i]==abecedary_lower[7]){
			h_MI(fd);
		}
		if(arr[i]==abecedary_lower[8]){
			i_MI(fd);
		}
		if(arr[i]==abecedary_lower[9]){
			j_MI(fd);
		}
		if(arr[i]==abecedary_lower[10]){
			k_MI(fd);
		}
		if(arr[i]==abecedary_lower[11]){
			l_MI(fd);
		}
		if(arr[i]==abecedary_lower[12]){
			m_MI(fd);
		}
		if(arr[i]==abecedary_lower[13]){
			n_MI(fd);
		}
		if(arr[i]==abecedary_lower[14]){
			o_MI(fd);
		}
		if(arr[i]==abecedary_lower[15]){
			p_MI(fd);
		}
		if(arr[i]==abecedary_lower[16]){
			q_MI(fd);
		}
		if(arr[i]==abecedary_lower[17]){
			r_MI(fd);
		}
		if(arr[i]==abecedary_lower[18]){
			s_MI(fd);
		}
		if(arr[i]==abecedary_lower[19]){
			t_MI(fd);
		}
		if(arr[i]==abecedary_lower[20]){
			u_MI(fd);
		}
		if(arr[i]==abecedary_lower[21]){
			v_MI(fd);
		}
		if(arr[i]==abecedary_lower[22]){
			w_MI(fd);
		}
		if(arr[i]==abecedary_lower[23]){
			x_MI(fd);
		}
		if(arr[i]==abecedary_lower[24]){
			y_MI(fd);
		}
		if(arr[i]==abecedary_lower[25]){
			z_MI(fd);
		}
	}
}